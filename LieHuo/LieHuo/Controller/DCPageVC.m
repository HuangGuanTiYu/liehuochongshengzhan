...
-(void)backInDCPageTopView:(DCPageTopView *)topView
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"FanHui" object:@{@"index" : [NSString stringWithFormat:@"%ld",(long)self.index]}];
...
-(DCBookListView *)listView
{
    if(_listView == nil)
    {
        _listView = [[DCBookListView alloc]initWithFrame:CGRectMake(-kScreenW * 0.8, 0, kScreenW,kScreenH - 64 - 20)];
