...
- (void)initSubviews
{
    ...
    [self.faceBtn setTitleColor:RGBCOLOR_HEX(0x666666) forState:UIControlStateDisabled];
    [self.faceBtn setTitleColor:RGBCOLOR_HEX(0xFF5858) forState:UIControlStateNormal];
...
- (void)setbarSubViewsFrame
{
    ...
    if (self.allowFace){
        self.faceBtn.frame = CGRectMake(self.frame.size.width - ItemW - CGRectGetWidth(self.moreBtn.frame) - 3, barViewH - ItemH, ItemW, ItemH);
    }else {
    ...
    self.textView.frame = CGRectMake(textViewX, TextViewVerticalOffset, textViewW - 10, self.textView.frame.size.height);
...
- (void)textViewDidChange:(UITextView *)textView
{
    ...
    self.faceBtn.enabled = textView.text.length > 0;
