...
- (void)initSubViews
{
    ...
    _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height - kUIPageControllerHeight - 10, self.frame.size.width, kUIPageControllerHeight)];
